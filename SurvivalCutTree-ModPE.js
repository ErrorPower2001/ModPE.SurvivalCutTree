cutTree = function( x , y , z )
{
    if( Level.getTile( x , y , z ) == 17 || Level.getTile( x , y , z ) == 162 )
    {
        ...
        if( Level.getData( x , y , z ) == 1 || Level.getData( x , y , z ) == 5 || Level.getData( x , y , z ) == 9 )
        {
            preventDefault();
        ...
        if( Level.getData( x , y , z ) == 2 || Level.getData( x , y , z ) == 6 || Level.getData( x , y , z ) == 10 )
        {
            preventDefault();
        ...
        if( Level.getData( x , y , z ) == 3 || Level.getData( x , y , z ) == 7 || Level.getData( x , y , z ) == 11 )
        {
            preventDefault();
